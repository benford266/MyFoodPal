                            ...
                            with ui.card().classes(f'recipe-card {theme["card"]} {theme["border"]} rounded-3xl p-6 sm:p-8 w-full'):
                                with ui.row().classes('items-center justify-between gap-4 mb-6'):
                                    with ui.row().classes('items-center gap-4'):
                                        ...
                                        ui.html(f'<h3 class="text-2xl font-bold {theme["text_primary"]}">{recipe.get("title", "Untitled Recipe")}</h3>')
                                        ...
                                        with ui.row().classes('gap-1 mt-2'):
                                            for star in range(1, 6):
                                                ...
                                                star_button = ui.button(
                                                    star_icon,
                                                    on_click=lambda idx=recipe_index, title=recipe.get("title", "Untitled Recipe"), r=star: rate_recipe(idx, title, r)
                                        ...
                                        with ui.column().classes('gap-2'):
                                            for ingredient in recipe.get("ingredients", []):
                                                with ui.row().classes('items-center gap-3'):
                                                    ...
                                                    ui.html(f'<span class="text-sm {theme["text_primary"]}">{ingredient}</span>')
